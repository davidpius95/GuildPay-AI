# GuildPay AI — Project Context (AGENTS.md)

> This file is read automatically at the start of every session by **Codex**
> and by **Google Antigravity** (which also reads AGENTS.md-style ambient context).
